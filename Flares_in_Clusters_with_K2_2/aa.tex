...
\\
StarHorse~\citep{queiroz_starhorse_2018} is a Bayesian tool that uses a set of measured spectrophotometric parameters to determine posterior distributions for stellar properties like stellar mass, age, and $T_\mathrm{eff}$. \citet{queiroz_starhorse_2018} applied the algorithm[...] %What are the uncertainties on Teff
\\
...
We used a catalog of empirically characterised stars~\citep{yee_specmatch_2017} to derive $R_*$ from $T_\mathrm{eff}$. \citet{yee_specmatch_2017} collected 404 stars with high-resolution spectra from the literature, and own observations of mid to late K-dwarfs, spanning low mass stars from 7000\;K down to 3000\;K. For these stars, the resulting catalog is accurate to 100\;K in
