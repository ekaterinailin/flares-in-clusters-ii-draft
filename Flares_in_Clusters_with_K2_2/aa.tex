...
\begin{figure}[ht!]
    ...
    \caption{\textbf{Single confirmed flare candidate in M67 on the K1 dwarf EPIC 211434440. The amplitude is \input{values/m67flare_amplitude_perc.txt}\unskip, and the flare energy emitted in the Kepler band is $E_\mathrm{Kp}=$\input{values/m67flare_energy.txt}.}}          
    \label{fig:m67}
\end{figure}
%-------------------------------------------
