...
\begin{figure*}
    \centering
    \includegraphics[width=0.49\hsize]{pics/FFDs/08_04_2020_16_56_full_sample_ffd_ED.png}
    \hspace{.01cm}
    \includegraphics[width=0.49\hsize]{pics/FFDs/08_04_2020_16_56_full_sample_ffd_energy.png}
...
\begin{figure*}
    \centering
    \includegraphics[width=16cm]{pics/FFDs/08_04_2020_16_56_SpT_wise_sample_ffd_ED.png}
    \caption{FFDs (scatter) in $ED$ and respective power law fits with $\alpha=XXX$ (black lines).}          	\label{powerlawfits_s}
\end{figure*}

\begin{figure*}
    \centering
    \includegraphics[width=16cm]{pics/FFDs/08_04_2020_16_56_SpT_wise_sample_ffd_energy.png}
...
%-------------------------------------------
\begin{table*}
\caption{Summary of flaring $\beta$ of all clusters and $T_\mathrm{eff}$ bins in energy and $ED$ distributions.}\label{powerlawtable}
\centering
\tiny
