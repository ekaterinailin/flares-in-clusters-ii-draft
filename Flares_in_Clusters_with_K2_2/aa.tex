...
\section{Data}
This is work is based on K2 30-minute cadence light curves that were provided by the Kepler archives hosted at MAST. To assign $T_\mathrm{eff}$ to the stars for which these observation had been obtained we used multiband photometry from Tycho, UCAC4, 2MASS, Pan-STARRS, and Gaia catalogs. To assign ages to the targeted stars, OC membership information was compiled from the literature. An overview over the cluster sample is presented in Table \ref{tab:data_clusters} and illustrated in Figure \ref{fig:OCs}.
