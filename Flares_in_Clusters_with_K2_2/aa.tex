...
\\
Gaia DR2 published $T_\mathrm{eff}$ for over 160 million sources~\citep{gaia2018}. The typical uncertainty was quoted at 324 K, but it was lower for stars above $\sim$4100 K and below $\sim$6700K, so that we \textbf{adopted} 175 K which \textbf{was} above the quoted root-median-squared error in this $T_\mathrm{eff}$ range, and \textbf{used} provided values only in this range, \textbf{as the pipeline systematically overestimated the temperatures for M dwarfs~\citep{andrae_gaiaapsis_2018}}. 
\\ 
